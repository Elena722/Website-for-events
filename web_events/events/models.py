...
class Events(models.Model):
    ...
    coordinates_latitude = models.DecimalField(max_digits=20, decimal_places=16, null=True, blank=True)
    coordinates_longitude = models.DecimalField(max_digits=20, decimal_places=16, null=True, blank=True)
